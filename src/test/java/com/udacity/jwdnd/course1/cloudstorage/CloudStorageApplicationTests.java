...
class CloudStorageApplicationTests {
	...
	public void testAddEditDeleteCredential(){
		...
		String addNewUsername = "huylq16";
		String addNewPassword = "123456";
		HomePageTest homePageTest = new HomePageTest(driver);
		homePageTest.navToCredentialsTab();
		homePageTest.openNewCredentialModal();
		homePageTest.setCredentialUrl(addNewUrl);
		homePageTest.setCredentialUsername(addNewUsername);
		homePageTest.setCredentialPassword(addNewPassword);
		homePageTest.saveChangesCredential();
		homePageTest.clickContinueOnResult();
		homePageTest.navToCredentialsTab();

		Assertions.assertEquals(addNewUrl,homePageTest.getFirstCredential().getUrl());
		Assertions.assertEquals(addNewUsername,homePageTest.getFirstCredential().getUsername());
		Assertions.assertNotEquals(addNewPassword,homePageTest.getFirstCredential().getPassword());

...
public class HomePageTest {
    ...
    @FindBy(id="elementCredentialUrl")
    private WebElement credentialUrl;

    @FindBy(id="elementCredentialUsername")
    private WebElement credentialUsername;

    @FindBy(id="elementCredentialPassword")
    private WebElement credentialPassword;

    @FindBy(id = "credentialSubmit")
    private WebElement btnCredentialSubmit;

    @FindBy(id="result-page-success")
    public WebElement aHrefContinue;
    ...
    public void clickContinueOnResult(){
        js.executeScript("arguments[0].click();", aHrefContinue);
    }
